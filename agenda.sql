...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Mar 2020 pada 15.25
...
--
-- Struktur dari tabel `pengajuan_rapat`
--
...
--
-- Dumping data untuk tabel `pengajuan_rapat`
--
...
(15, 'rapat dengan vendor', '2020-03-26', '02:00:00', 0, ''),
(16, 'rapat dengan otaku', '2020-03-31', '21:30:00', 1, 'Rapat dengan vendor pada ruangan III/D');

--
-- Trigger `pengajuan_rapat`
--
DELIMITER $$
...
--
-- Struktur dari tabel `tugas_divisi`
--
...
--
-- Dumping data untuk tabel `tugas_divisi`
--
...
(9, 'penambahan karyawan baru', '2019-11-30', '12:00:00', 'finance, accounting, and tax', '', 'serah', '417455kawai.png'),
...
(16, 'pemecatan karyawan', '2019-12-15', '03:04:00', '', '', '', '55035WebBanner_1.jpg'),
...
(20, 'rapat bulanan', '2019-12-01', '14:00:00', 'finance, accounting, and tax', '', 'rekap keuangan bulan november', '279908kaneki.jpg'),
...
(23, 'rapat mingguan', '2019-12-08', '12:00:00', 'supply chain management', 'awd', 'wqdqd', ''),
(24, 'pemecatan karyawan', '2019-12-15', '03:04:00', 'bussiness and development', 'fasfda', 'adsdasd', '0'),
(25, 'rapat dengan vendor', '2020-03-26', '02:00:00', '', '', '', ''),
(26, 'rapat dengan otaku', '2020-03-31', '21:30:00', '', '', '', ''),
(27, 'rapat dengan otaku', '2020-03-31', '21:30:00', 'bussiness and development', 'Pak Samidi', 'Dokumentasi', '');
...
(1, 'gjhack', '1', 'pimpinan', 'gjhack.jpg'),
(2, 'Zakky Firdaus', '1', 'admin', 'ridho darmawan.jpg'),
(3, 'info', '1', 'pegawai', 'info.jpg'),
(5, 'Administrator Sekretariat Utama', '1', 'sekretariat utama', 'rona.jpg'),
(6, 'Administrator Deputi 1', '1', 'deputi 1', 'rini.jpg'),
(8, 'Administrator Deputi 2', '1', 'deputi 2', 'fitra.jpg'),
(9, 'Administrator Deputi 3', '1', 'deputi 3', 'Administrator Deputi 4.jpg'),
(10, 'Administrator Deputi 4', '1', 'deputi 4', 'Administrator Deputi 4.jpg'),
(11, 'Administrator Deputi 5', '1', 'deputi 5', 'Administrator Deputi 5.jpg');
...
--
-- Indeks untuk tabel `pengajuan_rapat`
--
ALTER TABLE `pengajuan_rapat`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tugas_divisi`
--
...
--
-- AUTO_INCREMENT untuk tabel `pengajuan_rapat`
--
ALTER TABLE `pengajuan_rapat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `tugas_divisi`
--
ALTER TABLE `tugas_divisi`
