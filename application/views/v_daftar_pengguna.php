							...
							<table id="datable_1" class="table table-hover display  pb-30">
								<thead>
									<tr>
										...
										<th data-field="tema" data-sortable="true"> NIP </th>
										<th data-field="tanggal" data-sortable="true" data-width="100"> Nama </th>
										<th data-field="jam" data-sortable="true"> Tipe </th>
				...
				<form action="<?= base_url('c_admin/tambah_pengguna'); ?>" role="from" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control" name="tipe">
							...
							<option value="deputi 5">Deputi 5</option>
						</select>
					</div>
					<div class="form-group">
