	...
	<div class="wrapper theme-2-active pimary-color-gold">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="<?= base_url('c_pimpinan') ?>">
						<div class="pull-left"><i class="fa fa-home mr-20"></i><span class="right-nav-text">Dashboard</span></div>
				...
				<?php if ($this->session->userdata('tipe') == 'admin') : ?>
					...
					<li>
						<a href="<?= base_url('c_admin/daftar_pengguna') ?>">
							<div class="pull-left"><i class="fa fa-users mr-20"></i><span class="right-nav-text">Daftar Pengguna</span></div>
							<div class="clearfix"></div>
						</a>
					</li>
					...
					<li>
						<a href="<?= base_url('c_admin/usulan_rapat') ?>">
							<div class="pull-left"><i class="fa fa-comment mr-20"></i><span class="right-nav-text">Usulan Rapat</span></div>
							<?php if ($info != 0) : ?>
				...
				<?php if ($this->session->userdata('tipe') != 'admin' && $this->session->userdata('tipe') != 'pimpinan') : ?>
					...
					<li>
						<a href="<?= base_url('c_karyawan/undangan_rapat') ?>">
							<div class="pull-left"><i class="fa fa-envelope mr-20"></i><span class="right-nav-text">Undangan Rapat</span></div>
							<?php if ($info != 0) : ?>
								<div class="pull-right">
									<span class="label label-warning"><?= $info; ?></span>
								</div>
				...
				<?php if ($this->session->userdata('tipe') != 'admin' && $this->session->userdata('tipe') != 'pimpinan' && $this->session->userdata('tipe') != 'karyawan') : ?>
					...
					<li>
						<a href="<?= base_url('c_divisi/Bussiness') ?>">
							<div class="pull-left"><i class="fa fa-book mr-20"></i><span class="right-nav-text">Tugas Rapat</span></div>
				...
				<?php if ($this->session->userdata('tipe') == 'pimpinan' || $this->session->userdata('tipe') == 'admin') : ?>
					...
					<?php if ($this->session->userdata('tipe') == 'pimpinan') : ?>
						...
						<li>
							<a href="<?= base_url('c_pimpinan/pengajuan_rapat'); ?>">
								<div class="pull-left"><i class="fa fa-pencil-square mr-20"></i><span class="right-nav-text">Pengajuan rapat</span></div>
								<div class="clearfix"></div>
							</a>
						</li>
					<?php endif; ?>
					...
					<li>
						<a href="javascript:void(0);" data-toggle="collapse" data-target="#maps_dr">
							<div class="pull-left"><i class="fa fa-list-alt mr-20"></i><span class="right-nav-text">Departemen on BPIP</span></div>
							<div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div>
							<div class="clearfix"></div>
						</a>
						<ul id="maps_dr" class="collapse collapse-level-1">
							<li>
								<a href="<?= base_url('c_divisi/bussiness'); ?>">Sekretariat Utama</a>
							</li>
							<li>
								<a href="<?= base_url('c_divisi/finance') ?>">Deputi 1</a>
							</li>

							<li>
								<a href="<?= base_url('c_divisi/human') ?>">Deputi 2</a>
							</li>

							<li>
								<a href="<?= base_url('c_divisi/supply') ?>">Deputi 3</a>
							</li>

							<li>
								<a href="<?= base_url('c_divisi/supply') ?>">Deputi 4</a>
							</li>

							<li>
								<a href="<?= base_url('c_divisi/supply') ?>">Deputi 5</a>
							</li>
					...
					<li>
						<a href="<?= base_url('c_admin/rekap'); ?>">
							<div class="pull-left"><i class="fa fa-file mr-20"></i><span class="right-nav-text">Rekap Agenda Rapat</span></div>
							<div class="clearfix"></div>
						</a>
					</li>
				...
				<li>
					<a href="<?= base_url('c_login/logout'); ?>">
						<div class="pull-left"><i class="fa fa-power-off mr-20"></i><span class="right-nav-text">Logout</span></div>
						<div class="clearfix"></div>
					</a>
				</li>
